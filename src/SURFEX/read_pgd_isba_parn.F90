...
IF (IVERSION<7 .AND. .NOT.IO%LECOCLIMAP) THEN
  ...
  IF (LIRRIGMODE .OR. LAGRIP) THEN
    DTI%LDATA_IRRIGFRAC   = .TRUE.
  ELSE
    DTI%LDATA_IRRIGFRAC   = .FALSE.
  ENDIF 
  IF (LIRRIGMODE) THEN
    DTI%LDATA_WATSUP      = .TRUE. 
    DTI%LDATA_F2THRESHOLD = .TRUE.
    DTI%LDATA_IRRIGTYPE   = .TRUE. 
    DTI%LDATA_IRRIGTIME   = .TRUE. 
    DTI%LDATA_IRRIGFREQ   = .TRUE.  
  ELSE
    DTI%LDATA_WATSUP      = .FALSE. 
    DTI%LDATA_F2THRESHOLD = .FALSE.
